...
public class GenerateCustomReport extends UseCase{
	...
	GenerateCustomReportResultInterface resultInterface;
	
	public GenerateCustomReport(GenerateCustomReportResultInterface resultInterface, HashMap<String, List<String>> templateRealNameMap, Calendar begin, Calendar end) {
	...
	public void run() {
		...
		try {
			...
			resultInterface.onSuccessGenerateCustomReport(res);
		} catch (SelectException e) {
			resultInterface.onErrorGenerateCustomReport(e.getMessage());
		}
		// 
