...
public class FetchTemplateColumnsUseCase extends UseCase {
	...
	public FetchTemplateColumnsUseCase(ExistingTemplateResultInterface resultInterface,
			String template) {
	...
	public FetchTemplateColumnsUseCase(ResolveConflictResultInterface resultInterface,
			String template) {
