...
public class QueryOnDatabase {
	 ...
	 */
	public static boolean runInsertColumn(String columnName, String tableName)
	...
	/*
	 * formulate a list of String into a single string with comma separate them and each element in
	 * the list will wrap with quote
	 */
	...
	/*
	 * formulate a list of String into a single string with comma separate them and each element in
	 * the list will wrap with single quotation mark (')
	 */
	...
	/*
	 * formulate a list of String into a single string with comma separate them and each element in
	 * the list will wrap with back quotation mark (`)
	 */
	...
	public static int insertRowRawQuery(String tableName, String columnIds, String data)
		...
		String sql = "insert into " + tableName + columnIds + " values " + data + ";";
		Connection conn;
		try {
			conn = ConnectDatabase.connect();
			Statement st = conn.createStatement();
	...
	/*
	 * insert data into specific table (columnIds) given columnIds and data must match
	 */
	 ...
	 */
	public static List<String> selectColConstraint(String tableName, String columnId,
			String constraint) throws SelectException {
	...
	/*
	 * create an empty table that only contain the id attribute as primary key id is type int
	 * auto_inrement
	 */
	...
	public static boolean createTemplate(String temName, String tableName, List<String> columnIds,
			List<String> columnNames) throws AlterException, CreateException {
