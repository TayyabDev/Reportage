...
public class UpdateCommand extends Command {
	...
	public UpdateCommand(String tableName, List<String> targets, List<String> vals, List<String> constraints) {
	...
	public boolean handle() throws UpdateException {
		String sql;
		try {
			sql = "update " + tableName + " set " + matchTargetVals() + " where " + formatConstraints() + ";";
