...
public class CreateAccountPresenterImpl
		implements CreateAccountPresenter, CreateAccountResultInterface {
	...
	public void createAccount(String name, String password, String accountType) {
		if (view.isFieldsValid(name, password)) {
			CreateAccountUseCase useCase =
					new CreateAccountUseCase(this, name, password, accountType.substring(0, 1));
			useCase.run();
		} else {
